...
The native graph was exported with `gh api` using GitHub's blocked-by, blocking, parent, and sub-issue endpoints. Temporary GitHub Actions workflows were used only to provide an authenticated `gh` environment and were removed after verification.
