...
| `academics` | Module, module membership, lecture, timetable entry, timetable import, assignment, revision topic | University structure, teaching sessions, timetable import jobs, assignments, and revision topics |
