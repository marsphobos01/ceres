...
| Conversation | A direct or group messaging container | Conversation type as choice text; title as short text; created by user reference; created timestamp | Type limited to direct, group, or project |
